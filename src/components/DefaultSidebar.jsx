    ...
    <>
      <div className={`fixed left-0 z-40 ${isDefaultMenuOpen ? "md:w-auto lg:w-60 group" : ""} `}>
        ...
        >
          ...
          <div className={`hidden h-5 ${isDefaultMenuOpen? 'hidden lg:flex' : 'hidden'} items-center`}>
          ...
          <div className={`${isDefaultMenuOpen? 'hidden lg:flex flex-col' : 'hidden'} `}>
          ...
          {/* Divider */}
          <div className={ isDefaultMenuOpen ? "hidden h-5 lg:flex items-center":"hidden"}>
            <span className="bg-gray-300 border-b w-full"></span>
          </div>
